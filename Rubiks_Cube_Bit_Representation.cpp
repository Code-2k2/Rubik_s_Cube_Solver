...
#include "bits/stdc++.h"
class Rubiks_Cube_Bit_Representation : public Generic_Rubiks_Cube {
...
public:
    ...
    Rubiks_Cube_Bit_Representation() {
    ...
    bool operator==(const Rubiks_Cube_Bit_Representation &r1) const {
        for (int i = 0; i < 6; i++) {
    ...
    Rubiks_Cube_Bit_Representation &operator=(const Rubiks_Cube_Bit_Representation &r1) {
        for (int i = 0; i < 6; i++) {
    ...
    //Forming the 64 length string for the representation of one face of the Rubik's Cube
    uint64_t getCorners() {
        uint64_t ret = 0;
    ...
    struct HashBit {
        size_t operator()(const Rubiks_Cube_Bit_Representation &r1) const {
